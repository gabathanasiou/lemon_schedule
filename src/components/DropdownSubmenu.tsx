...
export default function DropdownSubmenu({ label, icon, width, side = 'right', children }: DropdownSubmenuProps) {
  ...
  const contentClasses = isLight
    ...
    : `bg-zinc-950/95 backdrop-blur-md border border-zinc-800 rounded-lg shadow-xl z-[210] text-zinc-300 p-1 flex flex-col font-sans select-none max-h-80 overflow-y-auto min-w-0 ${width || 'w-48'}`;
