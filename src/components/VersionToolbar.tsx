      ...
      <div className="flex items-center justify-between px-4 py-2">
        <div className="flex items-center gap-3">
          ...
          <div className="relative self-end -mb-2">
            <span className={`absolute top-0.5 -bottom-4 rounded-t-md pointer-events-none ${contentTheme === 'dark' ? 'bg-zinc-900 border-l border-r border-t border-zinc-600' : 'bg-white'}`} />
