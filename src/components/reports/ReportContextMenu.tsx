...
export interface MenuState { x: number; y: number; id: string; }
...
const ReportContextMenu: React.FC<ReportContextMenuProps> = ({ menu, block, project, insertScope, onClose, onChangeField, onInsertAbove, onInsertBelow, onAddChild, onDuplicate, onRemove }) => {
