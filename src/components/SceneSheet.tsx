          ...
          <table className="w-full border-collapse text-xs">
            <tbody>
              ...
              <tr className="border-b border-zinc-300">
                ...
                <td className="px-2.5 py-1.5 border-r border-zinc-300"><AutocompleteDropdown value={val('intExt')} readOnly={readOnly} onChange={v => scene && commitField(scene.id, 'intExt', v)} options={getIntExtOptions(project.colorPalette)} showAll /></td>
                <td className="px-2.5 py-1.5 text-[10px] font-bold text-zinc-700 uppercase bg-zinc-100 border-r border-zinc-300">Day/Night</td>
                <td className="px-2.5 py-1.5"><AutocompleteDropdown value={val('dayNight')} readOnly={readOnly} onChange={v => scene && commitField(scene.id, 'dayNight', v)} options={getDayNightOptions(project.colorPalette)} showAll /></td>
              </tr>
              <tr className="border-b border-zinc-300">
