...
const CATEGORIES: CategoryDef[] = [
  ...
  { key: 'extras', label: 'Supporting Artistes / Extras', getData: () => '' },
  { key: 'stunts', label: 'Stunts', getData: () => '' },
  { key: 'vehicles', label: 'Vehicles', getData: () => '' },
  { key: 'props', label: 'Props', getData: () => '' },
  { key: 'wardrobe', label: 'Wardrobe / Costume', getData: () => '' },
  { key: 'makeup', label: 'Makeup & Hair', getData: () => '' },
  { key: 'sfx', label: 'Special Effects (SFX)', getData: () => '' },
  { key: 'vfx', label: 'Visual Effects (VFX)', getData: () => '' },
  { key: 'sound', label: 'Sound', getData: () => '' },
  { key: 'music', label: 'Music / Playback', getData: () => '' },
  { key: 'animals', label: 'Animals', getData: () => '' },
  { key: 'weapons', label: 'Weapons / Armoury', getData: () => '' },
  { key: 'greenery', label: 'Greenery / Set Dressing', getData: () => '' },
  { key: 'art', label: 'Art Department', getData: () => '' },
