...
export interface CharacterAppearancesOptions {
  castIds: string[];
}

interface CharacterAppearancesDialogProps {
  onPrint: (opts: CharacterAppearancesOptions) => void;
  onClose: () => void;
}

export default function CharacterAppearancesDialog({ onPrint, onClose }: CharacterAppearancesDialogProps) {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-2xl w-[480px] max-h-[90vh] flex flex-col overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-200">
          <h2 className="text-lg font-bold text-zinc-900">Character Appearances</h2>
