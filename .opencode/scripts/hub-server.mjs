...
<p class="sub">One dev server per feature worktree · <a href="/hub.html" target="_blank" style="color:#60a5fa">Open viewer tabs</a> · hub on port ${HUB_PORT}</p>
<div id="list"></div>
<script>
