...
const REPORT = [
  ...
  'report-block-gap', 'report-chip-affix', 'report-smart-counts', 'report-collections',
  'report-sun-weather-map', 'report-violations',
...
const RULES = [
  ...
  { g: 'src/lib/digitSchedule.ts', s: SCHED },
  { g: 'src/lib/useDayClipboard.ts', s: ['glide-clipboard', ...SCHED] },
  { g: 'src/lib/useColumnResize.ts', s: RIBBON },
  ...
  { g: 'src/lib/daysOffSync.ts', s: CAL },
  { g: 'src/lib/events.ts', s: CAL },
  { g: 'src/components/DatePicker.tsx', s: [...CAL, ...RIBBON] },
  ...
  { g: 'src/components/ElementBreakdownView.tsx', s: REPORT },
  { g: 'src/components/CustomOrderSortModal.tsx', s: [...ELEM, ...CREW] },
  { g: 'src/lib/unsavedGuard.ts', s: MANAGERS },
  { g: 'src/components/CastTab.tsx', s: CAST },
  { g: 'src/lib/sceneDuplicates.ts', s: IMPORT },
  { g: 'src/lib/sceneDuplicate.tsx', s: IMPORT },
  ...
  { g: 'src/lib/callTimes.ts', s: ['day-manager', 'day-call-times', 'day-times-glide', 'report-collections'] },
  ...
  { g: 'src/lib/scriptIntegrity.ts', s: IMPORT },
  { g: 'src/components/ScriptIntegrityModal.tsx', s: IMPORT },
  { g: 'src/lib/usePaneResize.ts', s: IMPORT },
  { g: 'src/lib/useReportCtx.ts', s: REPORT },
  ...
  { g: 'src/components/AppHeader.tsx', s: 'ALL' },
  { g: 'src/components/DoodsTab.tsx', s: REPORT },
  { g: 'src/components/map/MapPrimitives.tsx', s: ['report-sun-weather-map'] },
  { g: 'src/lib/debugBridge.ts', s: ['debug-bridge'] },
  ...
  { g: 'src/components/ProjectCard.tsx', s: ['seeded-smoke'] },
